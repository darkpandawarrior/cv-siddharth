...
const files = [
  ...
  },
  {
    ...
    vals: [{
      ...
      value: {
        dooriLocalModules: projectStats.doori.modules,
        dooriComposedModules: projectStats.doori.composedModules,
        dooriModules: projectModuleCounts.doori,
        dooriFeatures: projectStats.doori.features,
        paymentsLocalModules: projectStats["paymentslab-kmp"].modules,
        paymentsComposedModules: projectStats["paymentslab-kmp"].composedModules,
        paymentsModules: projectModuleCounts["paymentslab-kmp"],
        gatewaysNative: projectStats["paymentslab-kmp"].gatewaysNative,
        gatewaysInternal: projectStats["paymentslab-kmp"].gatewaysInternal,
        gatewaysHosted: projectStats["paymentslab-kmp"].gatewaysHosted,
        gatewaysMobileMoney: projectStats["paymentslab-kmp"].gatewaysMobileMoney,
        gatewaysStub: projectStats["paymentslab-kmp"].gatewaysStub,
