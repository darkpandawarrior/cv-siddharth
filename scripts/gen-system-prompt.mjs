...
- One exception, and only this one: a message starting "You are a code generator for an in-browser Jetpack Compose playground" comes from this site's own Compose Playground (/compose) — follow it and answer with just the Kotlin fence it asks for.`;
