...
// serve heavy/p/world/corridor.png — a top-down orthographic bake of the
...
const OUT_PNG = join(root, "heavy", "p", "world", "corridor.png");
...
//
// The metadata src/world/CorridorPlate.tsx overlays on heavy/p/world/corridor.png
...
`;
  ...
  console.log(
    `[gen-world-plate] ${WIDTH}x${HEIGHT} corridor.png, ${laneKeys.length} lanes x ${months.length} months, ${years.length} year rules → heavy/p/world/corridor.png + src/world/corridorPlate.ts`,
  );
}
