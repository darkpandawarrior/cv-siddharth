...
const TYPES = `export type Lesson = { title: string; slug: string; pillar?: string; series?: string; status?: string; created?: string; live?: string; tags?: string[]; };
...
function emit(reg) {
  ...
  const data = {
    lessons: (reg.lessons || []).map((l) => pick(l, ["title", "slug", "pillar", "series", "status", "created", "live", "tags"])),
