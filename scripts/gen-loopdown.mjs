...
export type Lesson = { title: string; slug: string; pillar?: string; series?: string; status?: string; created?: string; live?: string; tags?: string[]; project: string | null; links: PostLinks };
