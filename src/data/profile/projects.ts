    ...
    detail: {
      ...
      sections: [
        ...
        },
        {
          ...
          body: "Every series traces back to a specific piece of shipped work, not a generic topic: \"Sensors Who Lie\" is field notes from Doori's location engine, \"The Coroutine Court\" from the −85% crash-reduction work, \"The Night Shift\" from the 50%→95% GPS accuracy work, \"Ghosts in the Recomposition\" from the ~87% Compose migration, and \"One Brain, Two Bodies\" from PaymentsLab-KMP's expect/actual split across targets. The writing has somewhere real to point back to.",
        },
        {
