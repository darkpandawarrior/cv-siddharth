...
export const projects: Project[] = [
  ...
  },
  {
    ...
    stack: ["Kotlin Multiplatform", "Compose Multiplatform", "Spring Boot 4", "Room (KMP)", "Ktor", "69 ATS/board providers"],
    highlights: [
      ...
      "69 ATS & job-board provider integrations and a zero-token scan path (direct Greenhouse/Ashby/Lever APIs, no LLM cost) inherited from the open-source engine it's built on.",
