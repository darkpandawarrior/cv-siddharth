...
export const projects: Project[] = [
  ...
  },
  {
    ...
    stack: ["Kotlin Multiplatform", "Compose Multiplatform", "Spring Boot 4", "Room (KMP)", "Ktor", "86 ATS/board providers"],
    highlights: [
      ...
      "86 ATS & job-board provider integrations and a zero-token scan path (direct Greenhouse/Ashby/Lever APIs, no LLM cost) inherited from the open-source engine it's built on.",
    ...
    detail: {
      ...
      metrics: [
        ...
        { value: "86", label: "ATS & job-board providers" },
      ...
      techStack: [
        ...
        { group: "Open-source engine (career-ops)", items: ["Node.js", "86 ATS/job-board providers", "zero-token Greenhouse/Ashby/Lever scanning", "A-F fit rubric"] },
      ],
      extraLinks: [
