...
export const incidents: Incident[] = [
  {
    ...
    what: "DENY blocks same-origin framing too — every live Wasm build was blank in production while passing in dev",
    days: 0,
    resolved: true,
  ...
  },
  {
    ...
    what: "raw.githubusercontent serves LFS pointers, not binaries — six real images were overwritten with 130 bytes of text",
    days: 0,
    resolved: true,
