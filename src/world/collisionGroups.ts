 ...
 *
 * Its own module because both a room's sensor and every dynamic body in the
 * world need to agree on it, and neither should own it — exporting it from a
 * component file costs fast refresh (the lint rule is right) and, more
 * importantly, made it look like a Props detail when it is a world-wide rule.
 *
