...
export const SKILLS: Skill[] = [
  {
    ...
    depth: "deep",
    evidence: "92% of a 738k-line production app is Compose, including the View interop layer",
  ...
  },
  {
    ...
    depth: "working",
    evidence: "Multi-module production codebase at 738k LOC with feature-level boundaries",
