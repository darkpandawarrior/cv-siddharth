...
export const SPINE: SpineEntry[] = [
  ...
  { id: "faq", file: "src/FloatingChat.tsx", kind: "block", selector: '[data-spine="faq"], section[aria-label="Frequently asked"]', routes: { except: NO_SITE_FOOTER }, maxHeight: { "1440": 240, "390": 180 }, debt: "SP-01", why: "17 answers, SSR-crawlable; docked as the footer's first band (F1, F2)" },
